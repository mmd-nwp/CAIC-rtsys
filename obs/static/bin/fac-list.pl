...
my $stntable = "$root/static/csv/fac-stations.csv";
my $remote = 1;

# Define zone codes.

my %zonecode;
$zonecode{"Whitefish Range"} = 1;
$zonecode{"Swan Range"} = 2;
$zonecode{"Flathead Range and Southern GNP"} = 3;
$zonecode{"Glacier National Park"} = 4;
$zonecode{"Mission Range"} = 5;
