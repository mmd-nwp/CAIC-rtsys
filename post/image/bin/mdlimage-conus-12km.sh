...
imgdir=/web/caic/$res/$model/forecasts
...
if [ $moca == 1 ]; then
  $root/bin/moca2rip.sh $domain $res $model $date $fcst
fi
...
g=1
mv gmeta.png $imgdir/$imgfcst-S-g$g-$prod.png
...
while [ $ct -lt $ndomain ]; do
  mv gmeta-$ct.png $imgdir/$imgfcst-S-g$g-$prod.png
  ct2=`expr $ct + $ndomain`
  mv gmeta-$ct2.png $imgdir/$imgfcst-S-g$g-$prod2.png
  g=`expr $g + 1`
  ct=`expr $ct + 1`
done
...
ndomain=1
while [ $ct -lt $ndomain ]; do
  mv gmeta-$ct.png $imgdir/$imgfcst-U-g$g-$prod.png
  ct2=`expr $ct + $ndomain`
  mv gmeta-$ct2.png $imgdir/$imgfcst-U-g$g-$prod2.png
  ct3=`expr $ct2 + $ndomain`
  mv gmeta-$ct3.png $imgdir/$imgfcst-U-g$g-$prod3.png
  ct4=`expr $ct3 + $ndomain`
  mv gmeta-$ct4.png $imgdir/$imgfcst-U-g$g-$prod4.png
  ct5=`expr $ct4 + $ndomain`
  mv gmeta-$ct5.png $imgdir/$imgfcst-U-g$g-$prod5.png
  ct6=`expr $ct5 + $ndomain`
  mv gmeta-$ct6.png $imgdir/$imgfcst-U-g$g-$prod6.png
  ct7=`expr $ct6 + $ndomain`
  mv gmeta-$ct7.png $imgdir/$imgfcst-U-g$g-$prod7.png
  g=`expr $g + 1`
  ct=`expr $ct + 1`
done
