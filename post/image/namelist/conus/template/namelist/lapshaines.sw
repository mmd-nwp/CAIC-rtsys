...
c38                  | 0.50 | 0.50  | 1.00 | 38
c34                  | 0.50 | 1.00  | 0.50 | 34
c30                  | 1.00 | 1.00  | 0.50 | 30
c66                  |1.00  |0.50   |1.00  | 66
c62                  |1.00  |0.50   |0.50  | 62
...
c28                  | 1.00 | 1.00  | 0.65 | 28
c31                  | 0.95 | 1.00  | 0.95 | 31
c35                  | 0.95 | 0.95  | 1.00 | 35
c36                  | 0.75 | 0.75  | 1.00 | 36
...
c30f                 | 1.00 | 1.00  | 0.05 | 73
c34f                 | 0.05 | 1.00  | 0.05 | 74
c38f                 | 0.05 | 0.05  | 1.00 | 75
c62f                 |1.00  |0.05   |0.05  | 76
---------------------------------------------------------------------------
===========================================================================
...
# Haines index (middle).
# Southwest domain.
feld=ham; ptyp=hc; hvbr=1; cmth=fill; cint=1; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=3; cend=6;>
  nmin; nmsg; titl=Haines_Index_(850-700mb);>
  cosq=            3,c38,>
         3,c34,    4,c34,>
         4,c30,    5,c30,>
         5,c66,    6,c66,>
...
# Haines index (upper).
# Southwest domain.
feld=hah; ptyp=hc; hvbr=1; cmth=fill; cint=1; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=3; cend=6;>
  nmin; nmsg; titl=Haines_Index_(700-500mb);>
  cosq=            3,c38,>
         3,c34,    4,c34,>
         4,c30,    5,c30,>
         5,c66,    6,c66,>
...
# Fosberg index.
# Southwest domain.
feld=fwi; ptyp=hc; hvbr=1; cmth=fill; cint=5; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=5; cend=100;>
  nmin; nmsg; titl=Fosberg_Fire_Weather_Index;>
  cosq=  0,c35,   20,c38f,>
        20,c31,   40,c34f,>
        40,c27,   60,c30f,>
        60,light.orange,  80,orange,>
        80,c59,   100,c62f,>
        100,brown
feld=fwi; ptyp=hc; linw=1; cint=20; colr=med.gray;>
   cbeg=20; cend=100;>
   smth=1; mjsk=0; nohl; nmin; nmsg; nttl
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=box; ptyp=hb; crsa=92.5,75.5; crsb=266.5,214.5
===========================================================================
