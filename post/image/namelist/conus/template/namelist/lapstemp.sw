...
# Temperature.
# Southwest domain.
feld=T2; ptyp=hc; cmth=fill; hvbr=1; cint=2.5; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=-30; cend=120; nmin; nmsg; >
  titl=Surface_Temperature_(F)_and_Wind_(kt); >
  cosq=-35,def.background,>
       -30,c66,  0,c63,>
         0,c38, 30,c35,>
        30,c31, 60,c34,>
        60,c27, 90,c30,>
        90,c59,120,c62,>
       120,def.background
#feld=T2; ptyp=hc; linw=1; cint=5; colr=med.gray;>
#   smth=1; mjsk=0; nohl; nmin; nmsg; nttl
feld=T2; ptyp=hc; linw=2; cint=2; colr=blue;>
  cbeg=32; cend=32; smth=1; mjsk=0; nohl; nolb; nmin; nmsg; nttl
...
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts;>
   linw=1; smth=0; intv=4; colr=dark.gray; nmin; nmsg; nttl
feld=box; ptyp=hb; crsa=92.5,75.5; crsb=266.5,214.5
===========================================================================
# Montana domain.
feld=T2; ptyp=hc; cmth=fill; hvbr=1; cint=2; >
...
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts;>
   linw=1; smth=0; intv=3; colr=dark.gray; nmin; nmsg; nttl
