...
# Moca temperature.
# Southwest domain.
feld=mtp; ptyp=hc; cmth=fill; hvbr=1; cint=2.5;>
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=-30; cend=120; nmin; nmsg; >
  titl=MOCA_Surface_Temperature_(F),_Wind_(kt),_and_Sea-Level_Pressure_(mb); >
  cosq=-35,def.background,>
       -30,c66,  0,c63,>
        ...
        90,c59,120,c62,>
       120,def.background
feld=mtp; ptyp=hc; linw=1; cint=2.5; colr=med.gray;>
  smth=1; mjsk=0; nmin; nmsg; nohl; nttl
feld=mtp; ptyp=hc; linw=2; cint=2; colr=blue;>
...
feld=suw,svw; ptyp=hv; vcmx=-15; fulb=10kts; nttl;>
  nmin; linw=1; smth=0; intv=4; colr=dark.gray; nmsg
feld=box; ptyp=hb; crsa=92.5,75.5; crsb=266.5,214.5
===========================================================================
# Montana domain.
feld=mtp; ptyp=hc; cmth=fill; hvbr=1; cint=2;>
  ...
  cosq=-35,def.background,>
       -30,c66,  0,c63,>
        ...
        90,c59,120,c62,>
       120,def.background
feld=mtp; ptyp=hc; linw=1; cint=2; colr=med.gray;>
  smth=1; mjsk=0; nmin; nmsg; nohl; nttl
feld=mtp; ptyp=hc; linw=2; cint=2; colr=blue;>
  cbeg=32; cend=32; smth=1; mjsk=0; nohl; nolb; nmin; nmsg; nttl
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=suw,svw; ptyp=hv; vcmx=-15; fulb=10kts; nttl;>
  nmin; linw=1; smth=0; intv=3; colr=dark.gray; nmsg
