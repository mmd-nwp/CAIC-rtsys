...
===========================================================================
# Moca dew point and wind.
# Southwest domain.
feld=mtd; ptyp=hc; cmth=fill; cint=2.5; hvbr=1;>
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=0; cend=80;>
  nmin; nmsg; titl=MOCA_Surface_Dew_Point_(F)_and_Wind_(kt);>
  cosq=  0,brown,>
         0,c62, 20,c59,>
        20,c30, 40,c27,>
        40,c35, 60,c38,>
        60,c31, 80,c34,>
        80,def.background
feld=mtd; ptyp=hc; linw=1; cint=2.5; colr=med.gray;>
...
===========================================================================
# Montana domain.
feld=mtd; ptyp=hc; cmth=fill; cint=2; hvbr=1;>
  ...
  cosq=  0,brown,>
        ...
        60,c31, 80,c34,>
        80,def.background
feld=mtd; ptyp=hc; linw=1; cint=2; colr=med.gray;>
   smth=1; mjsk=1; nohl; nmin; nmsg; nttl
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=suw,svw; ptyp=hv; vcmx=-15; fulb=10kts;>
