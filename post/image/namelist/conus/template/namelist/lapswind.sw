...
c30                  | 1.00 | 1.00  | 0.70 | 30
c31                  | 1.00 | 0.70  | 0.70 | 31
c34                  | 1.00 | 0.30  | 0.30 | 34
c35                  | 1.00 | 0.10  | 0.10 | 35
c38                  | 1.00 | 1.00  | 0.30 | 38
...
c63                  |0.30  |0.30   |1.00  | 63
c66                  |0.70  |0.70   |1.00  | 66
...
# Wind speed.
# Southwest domain.
feld=lspd; ptyp=hc; cmth=fill; hvbr=1; cint=5; >
  xwin=92,267; ywin=75,215; >
  titl=Surface_Wind_Speed_(kt); >
  smth=1; nmsg; cbeg=15; cend=60;>
  nmin; nmsg;>
  cosq=10,def.background,>
       15,c66, 30,c63,>
       30,c30, 45,c38,>
       45,c31, 60,c34,>
       60,c35
...
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts; nttl;>
  nmin; nmsg;>
...
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts; nttl;>
  nmin; nmsg;>
   linw=1; smth=0; intv=3; colr=dark.gray; nmsg
