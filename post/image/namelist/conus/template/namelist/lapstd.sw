...
dark.gray            | 0.25 | 0.25  | 0.25 |  5
red                  | 1.00 | 0.00  | 0.00 |  6
orange               | 1.00 | 0.50  | 0.00 |  7
yellow               | 1.00 | 1.00  | 0.00 |  8
green                | 0.00 | 1.00  | 0.00 |  9
blue                 | 0.00 | 0.00  | 1.00 | 10
violet               | 0.50 | 0.00  | 0.50 | 11
light.red            | 1.00 | 0.50  | 0.50 | 12
light.orange         | 1.00 | 0.75  | 0.50 | 13
light.yellow         | 1.00 | 1.00  | 0.50 | 14
light.green          | 0.50 | 1.00  | 0.50 | 15
light.blue           | 0.50 | 0.50  | 1.00 | 16
light.violet         | 0.75 | 0.50  | 0.75 | 17
dark.red             | 0.50 | 0.00  | 0.00 | 18
brown                | 0.50 | 0.25  | 0.00 | 19
dark.yellow          | 0.50 | 0.50  | 0.00 | 20
dark.green           | 0.00 | 0.50  | 0.00 | 21
dark.blue            | 0.00 | 0.00  | 0.50 | 22
...
===========================================================================
# Surface dew point and wind.
# Southwest domain.
feld=TD2; ptyp=hc; cmth=fill; hvbr=1; cint=2.5; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=0; cend=80;>
  nmin; nmsg; titl=Surface_Dew_Point_(F)_and_Wind_(kt);>
  cosq=  0,brown,>
         0,c62, 20,c59,>
        20,c30, 40,c27,>
        40,c35, 60,c38,>
        60,c31, 80,c34,>
        80,def.background
feld=TD2; ptyp=hc; linw=1; cint=2.5; colr=med.gray;>
   smth=1; mjsk=1; nohl; nmin; nmsg; nttl
...
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts;>
   linw=1; smth=0; intv=4; colr=dark.gray; nmsg; nmin; nmsg; nttl
feld=box; ptyp=hb; crsa=92.5,75.5; crsb=266.5,214.5
===========================================================================
# Montana domain.
feld=TD2; ptyp=hc; cmth=fill; hvbr=1; cint=2; >
  ...
  cosq=  0,brown,>
        ...
        60,c31, 80,c34,>
        80,def.background
feld=TD2; ptyp=hc; linw=1; cint=2; colr=med.gray;>
   smth=1; mjsk=1; nohl; nmin; nmsg; nttl
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=U10,V10; ptyp=hv; vcmx=-15; fulb=10kts;>
   linw=1; smth=0; intv=3; colr=dark.gray; nmsg; nmin; nmsg; nttl
feld=box; ptyp=hb; crsa=133.5,270.5; crsb=247.5,361.5
===========================================================================
# Surface dew point and lifted index.
# Southwest domain.
feld=TD2; ptyp=hc; cmth=fill; hvbr=1; cint=2.5; >
  xwin=92,267; ywin=75,215; >
  smth=1; cbeg=0; cend=80;>
  nmin; nmsg; titl=Surface_Dew_Point_(F)_and_Lifted_Index_(K);>
  cosq=  0,brown,>
         0,c62, 20,c59,>
        20,c30, 40,c27,>
        40,c35, 60,c38,>
        60,c31, 80,c34,>
        80,def.background
feld=lif; ptyp=hc; linw=1; cint=2; colr=def.foreground;>
   smth=1; mjsk=1; nohl; nmin; nmsg; nttl; dang=11; lwzr=2
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=box; ptyp=hb; crsa=92.5,75.5; crsb=266.5,214.5
===========================================================================
...
feld=TD2; ptyp=hc; cmth=fill; hvbr=1; cint=2; >
  ...
  cosq=  0,brown,>
        ...
        60,c31, 80,c34,>
        80,def.background
feld=lif; ptyp=hc; linw=1; cint=1; colr=def.foreground;>
   smth=1; mjsk=1; nohl; nmin; nmsg; nttl; dang=11; lwzr=2
feld=map; ptyp=hb; outy=Earth..2L5; ouds=solid; oulw=1; cint=360; colr=def.foreground
feld=map; ptyp=hb; outy=Earth..2L4; ouds=solid; oulw=2; cint=360; colr=def.foreground
feld=box; ptyp=hb; crsa=133.5,270.5; crsb=247.5,361.5
