...
c                                                                     c
     ...
     &   lmand,lsndg,cdiff,rdiff,ldfrl,lbogs,lppcb,lsncb,lhscb,lptcb,
     &   llpcb,lppmm,lsncm,lprcb,
     &   lcord,lpslb,
...
c
     ...
     &   lppcb(maxpl),lsncb(maxpl),lptcb(maxpl),
     &   lppmm(maxpl),lsncm(maxpl),lprcb(maxpl),
     &   llpcb(maxpl),lhscb(maxpl)
...
c                             !   0=hor; 1=ver
      ...
      lppcb(ipl)=.false.      ! no precip color bar (i.e. std color bar)
      lprcb(ipl)=.false.      ! no precip color bar (i.e. std color bar)
      lppmm(ipl)=.false.      ! no precip color bar (i.e. std color bar)
      lsncb(ipl)=.false.      ! no snow color bar (i.e. std color bar)
      lhscb(ipl)=.false.      ! no height of snow color bar (i.e. std color bar)
      lsncm(ipl)=.false.      ! no snow color bar (i.e. std color bar)
      lptcb(ipl)=.false.      ! no precip type bar (i.e. std color bar)
      llpcb(ipl)=.false.      ! no laps pcp color bar (i.e. std color bar)
